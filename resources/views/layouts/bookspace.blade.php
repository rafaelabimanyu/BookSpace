    ...
    <aside class="w-64 bg-secondary-blush border-r border-white/50 shadow-sm flex flex-col min-h-screen">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            @if(in_array(auth()->user()->role, ['admin', 'petugas']))
                ...
                <a href="{{ route('management.guide') }}" class="flex items-center px-4 py-3 rounded-2xl font-bold transition-premium active:scale-95 duration-100 {{ Request::routeIs('management.guide') ? 'bg-white shadow-sm text-primary-rose' : 'text-text-charcoal hover:translate-x-1 hover:bg-white/70 hover:text-primary-rose' }}">
            ...
            @if(auth()->user()->role === 'peminjam')
                ...
                <a href="{{ route('peminjam.sop') }}" class="flex items-center px-4 py-3 rounded-2xl font-bold transition-premium active:scale-95 duration-100 {{ Request::routeIs('peminjam.sop') ? 'bg-white shadow-sm text-primary-rose' : 'text-text-charcoal hover:translate-x-1 hover:bg-white/70 hover:text-primary-rose' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                    {{ __('SOP Panduan') }}
                </a>
            @endif
